...
class DatosZJ extends StatefulWidget {
  const DatosZJ({super.key});

  @override
  State<DatosZJ> createState() => _DatosZJState();
}

class _DatosZJState extends State<DatosZJ> {
  ...
  void _saveData(BuildContext context) {
    ...
    Provider.of<PlantaelecProvider>(context, listen: false).handleFirestoreOperation(action: "add",data: data);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Preop. Zanjadora'),
      ),
      body: Form(
        key: _formKey,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        // ...
                        _saveData(context); // función para guardar datos
