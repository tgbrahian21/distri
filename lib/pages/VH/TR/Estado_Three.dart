...
class _EstadosTHREECARState extends State<EstadosTHREECAR> {
  ...
  void _saveData() {
    ...
    String message = '''
      Luces de Tablero: $_selectedLucesTablero
      Nivel de combustible: $_selectedNivelCombustible
      Odómetro: $_selectedOdometro
      Pito: $_selectedPito
      Tacómetro: $_selectedTacometro

      Velocímetro: $_selectedVelocimetro
      Indicador de Aceite: $_selectedIndicadorAceite
      Indicador de Temperatura: $_selectedIndicadorTemperatura
