...
class PulidoraReportService {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  Future<void> generateAndSharePulidoraReport(String pulidoraId, String email) async {
    try {
      // Obtener los datos de la pulidora desde Firestore
      ...
      pdf.addPage(
        pw.Page(
          build: (pw.Context context) => pw.Column(
            ...
            children: [
              pw.Text('Reporte de la Pulidora', style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold)),
              ...
              pw.Text('Guía Guarda: ${data['guiaguardaPL']}'),
      ...
      // Compartir el PDF
      await Share.shareFiles([file.path], text: 'Reporte de la Pulidora');
    ...
    try {
      ...
      for (var doc in adminsQuerySnapshot.docs) {
        ...
        final message = Message()
          ...
          ..subject = 'Reporte de la Pulidora'
